...
<body>
    ...
    <?php
        ...
        if(isset($_POST['comprar'])){
            ...
            $datos="select carburante.tipo pro_nom, foto, precio_l, socio.nombre soc_nom, apellidos, puntos
                    from carburante, socio
                    where carburante.codigo=$_POST[id] and
                            socio.id=$_SESSION[socio]";
            $res=$con->query($datos);

            $fila=$res->fetch_array(MYSQLI_ASSOC);

            $total=$_POST['cantidad'] * $fila['precio_l'];
            ...
            echo"<div class='compra_pro'>
                    ...
                    <div class='info'>
                        ...
                        <p>La cantidad es de $_POST[cantidad] litros</p>
                ...
                ";
                    ...
                    if($fila['puntos']>=$total){
                        ...
                        $insertar="insert into pedido_car
                                    values(
                                            '',
                                            '$_SESSION[socio]',
                                            '$_POST[id]', 
