...
<body>
    ...
    <?php
        ...
        if(isset($_POST['comprar'])){
            ...
            $datos="select aceite.nombre pro_nom, foto, pre_pun, socio.nombre soc_nom, apellidos, puntos
                    from aceite, socio
                    where aceite.codigo=$_POST[id] and
            ...
            echo"<div class='compra_pro'>
                ...
                ";
                    ...
                    if($fila['puntos']>=$total){
                        ...
                        $insertar="insert into pedido_aceite 
                                    values(
                                            '',
                                            '$_SESSION[socio]',
                                            '$_POST[id]', 
