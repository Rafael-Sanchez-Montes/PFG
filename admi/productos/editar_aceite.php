...
<body>
    ...
    <?php
        ...
        echo"<form action='res_aceite.php' method='POST' class='form_editar'>
                <div class='row mb-3'>
                ...
                <div class='row mb-3'>
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' name='cantidad' id='cantidad' value='$fila[cantidad]'>
                    </div>
                </div>
                ...
                <div class='row mb-3'>
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' name='precio' id='precio' value='$fila[precio]'>
                    </div>
                </div>
